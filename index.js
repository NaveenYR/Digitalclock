const clock=()=>{
    ...
    seconds[0].innerText=second;
        ...
        message.innerText="GRAB SOME BREAKFAST!!!"
        ...
        let image=document.getElementById("greeting-image");
        image.src="tea.png";
        message.innerText=" GET SOME TEA.. ITS JUST EVENING!"
        ...
        if((hours===parseInt(night.value))){
            ...
            let message=document.getElementById("greeting");
            let image=document.getElementById("greeting-image");
            image.src="good night.png";
            message.innerText="GO TO SLEEP"
